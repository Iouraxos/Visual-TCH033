...
public class BandPassSeries extends AbstractRLCFilter {

	public BandPassSeries(Composite parent, int style) {
		super(parent, style);
	}
	...
	protected void recalculate(double f) {
		...
		z1 = Electrical.zSeries(zc, zl);
		zt = Electrical.zSeries(z1, zr);
